...
public final class Primitives {
	...
	/**
	 * Test the equality of two doubles by by converting their values into IEEE 754
	 ...
	 * @param abegin
	 * 			The begging index of the first byte array.
	 * @param b
	 * 			The second byte array.
	 * @param bbegin
	 * 			The begging index of the second byte array.
	 * @param length
